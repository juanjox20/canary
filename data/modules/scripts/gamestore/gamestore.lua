		...
		offers = {
            {
              ...
              itemtype = 45737,
              charges = 1,
              description = "Ring Backpack 40 Slots..",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45740,
              charges = 1,
              description = "Armor Backpack 40 Slots",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45741,
              charges = 1,
              description = "Legs Backpack 40 Slots",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45742,
              charges = 1,
              description = "Helmet Backpack 40 Slots",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45743,
              charges = 1,
              description = "Shield Backpack 40 Slots",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},		
            {
              ...
              itemtype = 45744,
              charges = 1,
              description = "Boots Backpack 40 Slots",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},				
            {
              ...
              itemtype = 45613,
              charges = 1,
              description = "Fast regeneration,Alfa Boots (Arm:5, critical hit chance 5%, critical extra damage +5%, damage reflection +10, speed +50, EpicHighlandBoots Regen HP 80 - MP 120).It weighs 8.00 oz..",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},		
            {
              icons = { "45730.png" },
              name = "Vip Access Hunts",
              price = 1500,
              itemtype = 45730,
              charges = 1,
              description = "Vip Token to receive Vip Access Hunts.",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},				
            {
              icons = { "45690.png" },
              name = "Highland Ring Vip",
              price = 1000,
              itemtype = 45690,
              charges = 1,
              description = "Highland Ring Te Da Un Bonus De Exp",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45857.png" },
              name = "Shadow Paladin Helmet",
              price = 1000,
              itemtype = 45857,
              charges = 1,
              description = "Arm:15, distance fighting +5, protection physical +5%, energy +5%, earth +5%, fire +5%, ice +5%, holy +5%, death +5%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {	
              icons = { "45862.png" },
              name = "Shadow Paladin Armor",
              price = 1000,
              itemtype = 45862,
              charges = 1,
              description = "Arm:15, distance fighting +4, protection physical +5%, fire +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45864.png" },
              name = "Shadow Paladin Legs",
              price = 1000,
              itemtype = 45864,
              charges = 1,
              description = "Arm:15, distance fighting +5, holy magic level +5, protection physical +8%, energy +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45867.png" },
              name = "Shadow Paladin boots",
              price = 1000,
              itemtype = 45867,
              charges = 1,
              description = "Arm:15, distance fighting +5, protection physical +5%, energy +5%, earth +5%, fire +5%, ice +5%, holy +5%, death +5%",
            ...
            {
              icons = { "45876.png" },
              name = "Shadow Paladin Bow",
              price = 1000,
              itemtype = 45876,
              charges = 1,
              description = "Range: 6, Atk +10, Hit% +10, distance fighting +5, critical hit chance 10%, critical extra damage +12%, protection earth +8%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
         icons = { "45877.png" },
              name = "Shadow Paladin CrossBow",
              price = 1000,
              itemtype = 45877,
              charges = 1,
              description = "Range: 6, Atk +10, Hit% +50, distance fighting +5, critical hit chance 10%, critical extra damage +12%, protection fire +8%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {				
              icons = { "45871.png" },
              name = "Shadow Paladin Quiver",
              price = 1000,
              itemtype = 45871,
              charges = 1,
              description = "magic level +3, Perfect Shot +30 at range 6",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45858.png" },
              name = "Shadow Mage Helmet",
              price = 1000,
              itemtype = 45858,
              charges = 1,
              description = "Arm:18, magic level +3, healing magic level +5, protection physical +4%, ice +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45861,
              charges = 1,
              description = "Arm:15, magic level +5, protection death +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45863.png" },
              name = "Shadow Mage Legs",
              price = 1000,
              itemtype = 45863,
              charges = 1,
              description = "Arm:15, magic level +5, protection fire +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45868,
              charges = 1,
              description = "Arm:5, magic level +5, healing magic level +5, protection physical +4%, fire +16%, speed +50",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
			  icons = { "45875.png" },
              name = "Shadow Mage WandRod",
              price = 1000,
              itemtype = 45875,
              charges = 1,
              description = "Atk:18, critical hit chance 10%, critical extra damage +12%, magic level +5, earth magic level +10, ice magic level +5, protection death +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45869.png" },
              name = "Shadow Mage Spellbooks",
              price = 1000,
              itemtype = 45869,
              charges = 1,
              description = "Def:44, magic level +5, healing magic level +5, ice magic level +5, protection physical +4%, energy +8%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {	
              icons = { "45859.png" },
              name = "Shadow Knight Helmet",
              price = 1000,
              itemtype = 45859,
              charges = 1,
              description = "Arm:15, club fighting +4, sword fighting +4, axe fighting +4, damage reflection +10, protection physical +6%, energy +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45860,
              charges = 1,
              description = "Arm:15, club fighting +5, sword fighting +5, axe fighting +5, damage reflection +10, protection physical +8%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45865.png" },
              name = "Shadow Knight Legs",
              price = 1000,
              itemtype = 45865,
              charges = 1,
              description = "Arm:15, club fighting +4, sword fighting +4, axe fighting +4, protection physical +10%, death +5%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45866.png" },
              name = "Shadow Knight Boots",
              price = 1000,
              itemtype = 45866,
              charges = 1,
              description = "Arm:5, club fighting +4, sword fighting +4, axe fighting +4, protection physical +5%, fire +8%, speed +50",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45873.png" },
              name = "Shadow Knight Axe",
              price = 1000,
              itemtype = 45873,
              charges = 1,
              description = "Atk:11 physical + 80 holy, Def:30, axe fighting +5, critical hit chance 20%, critical extra damage +22%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45872.png" },
              name = "Shadow Knight Sword",
              price = 1000,
              itemtype = 45872,
              charges = 1,
              description = "(Atk:10 physical + 88 holy, Def:30 +6, sword fighting +5",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45874.png" },
              name = "Shadow Knight Hammer",
              price = 1000,
              itemtype = 45874,
              charges = 1,
              description = "Atk:25 physical + 88 holy, Def:35 +9, club fighting +5",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45870.png" },
              name = "Shadow Knight Shield",
              price = 1000,
              itemtype = 45870,
              charges = 1,
              description = "Def:50, protection physical +10%, death +10%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {			
              icons = { "45689.png" },
              name = "Higland Amulet Vip",
              price = 1000,
              itemtype = 45689,
              charges = 1,
              description = "Highland Amulet Te Da Un Bonus De Exp",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {			
              icons = { "45751.png" },
              name = "rainbow battleaxe",
              price = 700,
              itemtype = 45751,
              charges = 1,
              description = "(Atk:8 physical + 50 death, Def:35, axe fighting +5, critical hit chance 10%, critical extra damage +12%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45746,
              charges = 1,
              description = "(Atk:8 physical + 46 fire, Def:32 +3, sword fighting +5",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45747.png" },
              name = "rainbow bludgeon",
              price = 700,
              itemtype = 45747,
              charges = 1,
              description = "(Atk:8 physical + 50 earth, Def:35, club fighting +5, critical hit chance 10%, critical extra damage +12%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45748,
              charges = 1,
              description = "(Range: 6, Atk +9, Hit% +6, distance fighting +4, critical hit chance 10%, critical extra damage +12%, protection earth +6%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45749,
              charges = 1,
              description = "(Range: 6, Atk +10, Hit% +7, distance fighting +4, critical hit chance 10%, critical extra damage +12%, protection fire +6%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              ...
              itemtype = 45750,
              charges = 1,
              description = "Atk:8 physical + 46 death, Def:32 +3, club fighting +5",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},		
            {
              ...
              itemtype = 45753,
              charges = 1,
              description = "Atk:8 physical + 50 energy, Def:35, sword fighting +5, critical hit chance 10%, critical extra damage +12%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},	
            {
              icons = { "45752.png" },
              name = "rainbow wandrod",
              price = 700,
              itemtype = 45752,
              charges = 1,
              description = "Atk:150, critical hit chance 10%, critical extra damage +5%, magic level +5, earth magic level +1, protection death +7%",
              type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			  movable = true
			},				
			{
		...
		offers = {
			{
				...
				price = 30,
				id = 65010,
				description = "<i>Purchase a boost that increases the experience points your character gains from hunting by 10%!</i>\n\n{character}\n{info} lasts for 1 hour hunting time\n{info} paused if stamina falls under 14 hours\n{info} can be purchased up to 5 times between 2 server saves\n{info} price increases with every purchase\n{info} cannot be purchased if an XP boost is already active",
				type = GameStore.OfferTypes.OFFER_TYPE_EXPBOOST,
			},		
			{
				icons = { "XP_Boost.png" },
