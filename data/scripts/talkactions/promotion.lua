...
function promotion.onSay(player, words, param)
    ...
    elseif player:getLevel() < 250 then
        player:sendCancelMessage("I am sorry, but I can only promote you once you have reached level 250.")
        player:getPosition():sendMagicEffect(CONST_ME_POFF)
    elseif not player:removeMoneyBank(2000000) then
