...
function onGetFormulaValues(player, skill, attack, factor)
	...
	local min = (level / 5) + (skill + 2 * attack) * 1.5 + 200
	local max = (level / 5) + (skill + 2 * attack) * 3.15 + 400
...
function onGetFormulaValues(player, skill, attack, factor)
	local level = player:getLevel()
	local min = (level / 5) + (skill + 3 * attack) * 1.85 + 220
	local max = (level / 5) + (skill + 3 * attack) * 3.4 + 450
	return -min * 1.1, -max * 1.1 
end
else 
function onGetFormulaValues(player, skill, attack, factor)
	local level = player:getLevel()
	local min = (level / 5) + (skill + 2 * attack) * 1.1 + 200
	local max = (level / 5) + (skill + 2 * attack) * 3 +  450
