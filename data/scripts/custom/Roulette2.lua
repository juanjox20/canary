local config = {
    ...
    playItem = {
        itemId = 45933, -- item required to pull lever
        count = 1
    },
    rouletteOptions = {
    ...
    prizePool = {
        {itemId = 22118, count = {5, 15},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 3389, count = {1, 1},    chance = 9000 }, -- demon legs
        {itemId = 3386, count = {1, 1},    chance = 9000 }, -- dragon scale mail		
        {itemId = 3079, count = {1, 1},    chance = 8500 }, -- boots of haste
        {itemId = 3392, count = {1, 1},    chance = 7500 }, -- royal helmet
        {itemId = 11455, count = {1, 1},    chance = 7500 }, -- roulette token		
        {itemId = 8778, count = {1, 1}, chance = 5000 }, -- Addon Doll     -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 45933, count = {1, 3},    chance = 4000 }, -- roulette token
        {itemId = 3366, count = {1, 1},    chance = 1500 }, -- magic plate armor
        {itemId = 3364, count = {1, 1},    chance = 3000 }, -- golden legs
        {itemId = 3360, count = {1, 1},    chance = 3500 }, -- golden armor				
        {itemId = 3555, count = {1, 1},    chance = 500  },  -- golden boots
        {itemId = 3365, count = {1, 1},    chance = 500  },  -- golden helmet		
        {itemId = 45975, count = {1, 2},    chance = 600  }  -- vip token		
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(15, 416, 7),
        Position(16, 416, 7),
        Position(17, 416, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(18, 416, 7),
        Position(19, 416, 7),
        Position(20, 416, 7),
    }
...
local disableMovingItemsToRoulettePositions1 = MoveEvent()

disableMovingItemsToRoulettePositions1.onAddItem = function(moveitem, tileitem, position, item, count, fromPosition, toPosition)
...
disableMovingItemsToRoulettePositions1:position(config.roulettePositions)
disableMovingItemsToRoulettePositions1:register()