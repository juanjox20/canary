local config = {
    ...
    playItem = {
        itemId = 11455, -- item required to pull lever
        count = 1
    },
    rouletteOptions = {
    ...
    prizePool = {
        {itemId = 3043, count = {10, 50},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 3382, count = {1, 1},    chance = 9000 }, -- crown legs
        {itemId = 3381, count = {1, 1},    chance = 9000 }, -- crown armor		
        {itemId = 3079, count = {1, 1},    chance = 8500 }, -- boots of haste
        {itemId = 3392, count = {1, 1},    chance = 7500 }, -- royal helmet
        {itemId = 3155, count = {50, 100},   chance = 6500 }, -- sudden death rune -- runes are given as stackable items, even tho they have 'charges'
        ...
        {itemId = 11455, count = {1, 3},    chance = 4000 }, -- roulette token
        {itemId = 3364, count = {1, 1},    chance = 3000 }, -- golden legs
        {itemId = 3360, count = {1, 1},    chance = 3000 }, -- golden armor		
        {itemId = 3366, count = {1, 1},    chance = 1500 }, -- magic plate armor
        {itemId = 3555, count = {1, 1},    chance = 500  },  -- golden boots
        {itemId = 45933, count = {1, 3},    chance = 400 } -- roulette token		
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(31, 416, 7),
        Position(32, 416, 7),
        Position(33, 416, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(34, 416, 7),
        Position(35, 416, 7),
        Position(36, 416, 7),
    }
