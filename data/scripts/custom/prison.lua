...
local prison = {
    ...
    materialId = 5880, -- ore ID recieved from mining
    ...
    position = Position(2431,2485,8), --position of your prison
    templePosition = Position(2498,2499,7), -- currently Thais Temple
...
prisonTalkaction:groupType("normal")
