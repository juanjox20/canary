local Palanca2 = Action()

function Palanca2.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	local teleportPosition = { x = 1273, y = 72, z = 5 }
	local stonePosition = { x = 1299, y = 108, z = 5 }
	...
	elseif item.itemid == 2773 then
		Position(stonePosition):hasCreature({ x = 1299, y = 108, z = 5 })
