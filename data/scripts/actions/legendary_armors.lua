...
function ArmorLegendary.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if tierCheck == nil or (tierCheck >= 0 and tierCheck <= 9) then
        if itemId == 673 and player:getItemById(16242, 1) and player:getMoney() + player:getBankBalance() >= 100000 then
            ...
            local allowedItemIds = {44908, 39147, 34094, 34096, 34095, 28719, 27648, 22537, 36663, 3397, 8862, 39165, 39164, 34157, 13993, 8038, 8039}
...
function ArmorEquipOn.onEquip(player, item, position, fromPosition)
    ...
    if currentDescription and currentDescription:lower():find("legendary tier") then
		...
		condition:setParameter(CONDITION_PARAM_SPECIALSKILL_LIFELEECHCHANCE, 0.5 * tier)
		condition:setParameter(CONDITION_PARAM_SPECIALSKILL_LIFELEECHAMOUNT, 0.5 * tier)
		condition:setParameter(CONDITION_PARAM_SPECIALSKILL_MANALEECHCHANCE, 0.5 * tier)
		condition:setParameter(CONDITION_PARAM_SPECIALSKILL_MANALEECHAMOUNT, 0.5 * tier)
        condition:setParameter(CONDITION_PARAM_SPECIALSKILL_CRITICALHITCHANCE, 0.5 * tier)		
        condition:setParameter(CONDITION_PARAM_SPECIALSKILL_CRITICALHITDAMAGE, 1 * tier)		
...
ArmorEquipOn:id(44908, 39147, 34094, 34096, 34095, 28719, 27648, 22537, 36663, 3397, 8862, 39165, 39164, 34157, 13993, 8038, 8039)
...
ArmorEquipOff:id(44908, 39147, 34094, 34096, 34095, 28719, 27648, 22537, 36663, 3397, 8862, 39165, 39164, 34157, 13993, 8038, 8039)
