...
monster.loot = {
	{ id = 3043, chance = 10000, maxCount = 70 }, 
...
monster.attacks = {
	{ name ="melee", interval = 3000, chance = 100, minDamage = -1500, maxDamage = -2800 },
	{ name ="combat", interval = 1000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -1400, maxDamage = -2500, length = 12, spread = 3, effect = 249, target = false },
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -1800, maxDamage = -2600, length = 12, spread = 3, effect = 193, target = false },
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -1200, maxDamage = -1500, length = 6, spread = 2, effect = CONST_ME_FIREAREA, target = false },
