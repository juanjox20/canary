...
monster.loot = {
	{ id = 3043, chance = 10000, maxCount = 55 }, 
...
monster.attacks = {
	{ name ="melee", interval = 2000, chance = 100, minDamage = -1400, maxDamage = -2400 },
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -1200, maxDamage = -1900, radius = 4, effect = CONST_ME_SMALLCLOUDS, target = false },
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -1300, maxDamage = -1900, range = 4, radius = 4, shootEffect = 31, effect = 248, target = true },
