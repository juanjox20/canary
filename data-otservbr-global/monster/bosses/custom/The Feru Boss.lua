local mType = Game.createMonsterType("The Feru Boss")
local monster = {}

monster.description = "The Feru Boss"
monster.experience = 1000000
monster.outfit = {
	lookTypeEx = 1739,
}

monster.health = 2750000
monster.maxHealth = 2750000
monster.race = "undead"
monster.corpse = 6078
monster.speed = 0
...
monster.loot = {
	...
	{ id = 5903, chance = 10, unique = true }, -- ferumbras' hat

}

monster.attacks = {
	{ name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 80, minDamage = -700, maxDamage = -2200, effect = CONST_ME_MORTAREA, shootEffect = CONST_ANI_SUDDENDEATH, target = true, range = 7 },
	{ name = "combat", type = COMBAT_LIFEDRAIN, interval = 2000, chance = 20, length = 8, spread = 0, minDamage = -900, maxDamage = -1800, effect = CONST_ME_ELECTRICALSPARK },
}
