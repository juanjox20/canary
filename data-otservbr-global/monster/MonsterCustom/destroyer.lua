local mType = Game.createMonsterType("The Destroyer")
local monster = {}
...
monster.loot = {
	...
	{ name = "gold coin", chance = 92500, maxCount = 489 },
	{ name = "small amethyst", chance = 5850, maxCount = 2 },
	{ name = "platinum coin", chance = 2250, maxCount = 8 },
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 333, maxDamage = -1000 },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 222, maxDamage = -999, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false },
}
