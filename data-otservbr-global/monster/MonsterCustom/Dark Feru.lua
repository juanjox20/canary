local mType = Game.createMonsterType("Dark Feru")
local monster = {}

monster.description = "a Dark Feru"
...
monster.summon = {
	maxSummons = 1,
	summons = {
		{ name = "fire elemental", chance = 20, interval = 1500, count = 1 },
	},
}
...
monster.loot = {
	...
	{ name = "gold coin", chance = 60000, maxCount = 350 },
	{ name = "gold coin", chance = 60000, maxCount = 166 },
	{ name = "crystal coin", chance = 3043, maxCount = 1 },		
	...
	{ name = "platinum coin", chance = 90540, maxCount = 2 },	
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 100, maxDamage = -2111 },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = 50, maxDamage = -1055, range = 7, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -1588, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "firefield", interval = 2000, chance = 10, range = 7, radius = 1, shootEffect = CONST_ANI_FIRE, target = true },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -600, maxDamage = -1522, length = 8, spread = 0, effect = CONST_ME_PURPLEENERGY, target = false },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -610, maxDamage = -1177, range = 1, shootEffect = CONST_ANI_ENERGY, target = true },
...
monster.defenses = {
	...
	armor = 120,
	mitigation = 1.74,
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 280, maxDamage = 499, effect = CONST_ME_MAGIC_BLUE, target = false },
