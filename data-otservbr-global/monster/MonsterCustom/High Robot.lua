local mType = Game.createMonsterType("The High Robot")
local monster = {}

monster.description = "High Feru"
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 555, maxDamage = -1200 },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 222, maxDamage = -1000, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false },
}
