local mType = Game.createMonsterType("The Plaguesmith")
local monster = {}
...
monster.loot = {
	...
	{ name = "gold coin", chance = 50000, maxCount = 200 },
	{ name = "gold coin", chance = 40000, maxCount = 199 },
	...
	{ name = "platinum coin", chance = 7142, maxCount = 6 },
...
monster.attacks = {
	{ name = "melee", interval = 1500, chance = 100, minDamage = 100, maxDamage = -999, condition = { type = CONDITION_POISON, totalDamage = 200, interval = 4000 } },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -80, maxDamage = -333, radius = 4, effect = CONST_ME_POISONAREA, target = false },
	{ name = "plaguesmith wave", interval = 2000, chance = 10, minDamage = -135, maxDamage = -666, target = false },
...
monster.defenses = {
	...
	armor = 120,
	mitigation = 1.32,
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_HEALING, minDamage = 235, maxDamage = 555, effect = CONST_ME_MAGIC_BLUE, target = false },
