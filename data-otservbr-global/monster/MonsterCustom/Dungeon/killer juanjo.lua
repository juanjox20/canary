local mType = Game.createMonsterType("Killer Juanjo")
local monster = {}

monster.description = "a killer juanjo noob"
monster.experience = 22222
monster.outfit = {
	lookType = 244,
	lookHead = 0,
	lookBody = 0,
...
monster.summon = {
	maxSummons = 3,
	summons = {
		{ name = "Demon", chance = 20, interval = 1500, count = 3 },
	},
}
...
monster.loot = {
	...
	{ name = "gold coin", chance = 100000, maxCount = 133 },
	{ name = "gold coin", chance = 100000, maxCount = 200 },
	{ name = "gold coin", chance = 100000, maxCount = 155 },
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 555, maxDamage = -3000 },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 222, maxDamage = -1555, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false },
}
...
monster.defenses = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 555, maxDamage = 1555, effect = CONST_ME_MAGIC_BLUE, target = false },
}
