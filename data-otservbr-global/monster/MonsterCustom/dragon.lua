local mType = Game.createMonsterType("The Dragon")
local monster = {}
...
monster.loot = {
	{ name = "gold coin", chance = 89920, maxCount = 219 },
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 100, maxDamage = -888 },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -125, maxDamage = -777, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -129, maxDamage = -666, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false },
}
...
monster.defenses = {
	...
	armor = 120,
	mitigation = 0.99,
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 69, maxDamage = 555, effect = CONST_ME_MAGIC_BLUE, target = false },
}
