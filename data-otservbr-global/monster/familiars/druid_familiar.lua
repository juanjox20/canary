...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -230, maxDamage = -500, range = 5, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_STONES, target = true },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -90, maxDamage = -500, length = 2, spread = 0, effect = CONST_ME_GROUNDSHAKER, target = false },
